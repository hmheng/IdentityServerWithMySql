...
using IdentityServerWithMySql.Models;
using IdentityServerWithMySql.Models.AccountViewModels;
using IdentityServerWithMySql.Services;
...
namespace IdentityServerWithMySql.Controllers
{
    [Authorize]
    [SecurityHeaders]
